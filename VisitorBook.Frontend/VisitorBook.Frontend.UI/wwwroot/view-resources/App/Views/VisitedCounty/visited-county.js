                ...
                render: function (data) {
                    return `
                            <div class="d-flex justify-content-around align-items-center">
                               <a onclick="showInPopup('/app/visitedcounty/edit/${data}', 
                               '${editModalTitleText}')" class="btn btn-warning"> ${editBtnText}</a>
                               <a onclick=deleteRecord('/app/visitedcounty/delete/${data}') class="btn btn-danger">
                                  ${deleteBtnText}
                               </a>
                            </div>
                            `
