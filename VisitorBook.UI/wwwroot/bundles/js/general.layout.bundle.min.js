 ...
 */
!function(n,t,i){function h(n){t.querySelectorAll(n=n||"select:not(.fsb-ignore)").forEach(a)}function a(n,i){var s,p;if(!n.nextElementSibling||!n.nextElementSibling.classList.contains("fsb-select")){var a=n.children,c=n.parentNode,u=t.createElement("span"),o=t.createElement("span"),r=t.createElement("button"),f=t.createElement("span"),l=t.createElement("span"),e=d++;for(n.classList.add("fsb-original-select"),o.id="fsb_"+e+"_label",o.className="fsb-label",o.textContent=v(n,c),r.id="fsb_"+e+"_button",r.className="fsb-button",r.textContent="&nbsp;",r.setAttribute("type","button"),r.setAttribute("aria-disabled",n.disabled),r.setAttribute("aria-haspopup","listbox"),r.setAttribute("aria-expanded","false"),r.setAttribute("aria-labelledby","fsb_"+e+"_label fsb_"+e+"_button"),f.className="fsb-list",f.setAttribute("role","listbox"),f.setAttribute("tabindex","-1"),f.setAttribute("aria-labelledby","fsb_"+e+"_label"),s=0,p=a.length;s<p;s++){var h=y(a[s],i),w=h.item,b=h.selected,h=h.itemLabel;f.appendChild(w);b&&(r.innerHTML=h)}u.className="fsb-select";u.appendChild(o);u.appendChild(r);u.appendChild(f);u.appendChild(l);n.style.display="none";n.nextSibling?c.insertBefore(u,n.nextSibling):c.appendChild(u);f.firstElementChild&&((u=t.createElement("span")).setAttribute("style","width: "+f.firstElementChild.offsetWidth+"px;"),l.className="fsb-resize",l.appendChild(u))}}function g(n,i){var s=n.children,a=n.parentNode,u=n.nextElementSibling,f,l;if(u&&u.classList.contains("fsb-select")){var h=u.firstElementChild,o=h.nextElementSibling,r=o.nextElementSibling,u=r.nextElementSibling,c=t.createDocumentFragment();for(h.textContent=v(n,a),o.setAttribute("aria-disabled",n.disabled),f=0,l=s.length;f<l;f++){var e=y(s[f],i),p=e.item,w=e.selected,e=e.itemLabel;c.appendChild(p);w&&(o.innerHTML=e)}for(;r.firstChild;)r.removeChild(r.firstChild);r.appendChild(c);r.firstElementChild&&u.firstElementChild.setAttribute("style","width: "+r.firstElementChild.offsetWidth+"px;")}}function v(n,i){var r,u=n.id;return("LABEL"===i.nodeName?r=i:void 0!==u&&(r=t.querySelector('label[for="'+u+'"]')),r)&&(u=[].filter.call(r.childNodes,function(n){return 3===n.nodeType}).map(function(n){return n.textContent.replace(/\s+/g," ").trim()}).filter(function(n){return""!==n})[0],u)?(r.onclick=function(t){n.nextElementSibling.querySelector("button").click();t.preventDefault();t.stopImmediatePropagation()},u):""}function y(n,i){var r=t.createElement("span"),u=n.selected,i=function(n,t){return"function"==typeof t?t(n):(t=n.text,n=n.getAttribute("data-icon"),t=""!==t?t:"&nbsp;",t="<span>"+t+"<\/span>",null!==n&&(t='<svg aria-hidden="true"><use href="'+n+'"><\/use><\/svg> '+t),t)}(n,i);return r.className="fsb-option",r.innerHTML=i,r.setAttribute("role","option"),r.setAttribute("tabindex","-1"),r.setAttribute("aria-selected",u),{item:r,selected:u,itemLabel:i}}function c(n){var r=n.getBoundingClientRect(),i=n.nextElementSibling,u=(u=i.querySelector('[aria-selected="true"]'))||i.firstElementChild;n.parentNode.className="fsb-select";n.setAttribute("aria-expanded","true");u.focus();s=n;r.y+r.height+i.offsetHeight>t.documentElement.clientHeight&&(n.parentNode.className="fsb-select fsb-top")}function u(n){var i=t.querySelector('.fsb-button[aria-expanded="true"]');i&&(i.setAttribute("aria-expanded","false"),n&&i.focus(),f="",e=null);s=null}function l(n){var t=n.parentNode,r=t.previousElementSibling,u=[].indexOf.call(t.children,n),i=t.querySelector('[aria-selected="true"]'),t=t.parentNode.previousElementSibling;i&&i.setAttribute("aria-selected","false");n.setAttribute("aria-selected","true");r.innerHTML=n.innerHTML;t.selectedIndex=u;t.dispatchEvent(new Event("input",{bubbles:!0}));t.dispatchEvent(new Event("change",{bubbles:!0}))}function p(n){n=function(n,t){var u,r=[].map.call(n.children,function(n){return n.textContent.trim().toLowerCase()}),i=w(r,t)[0];return i?n.children[r.indexOf(i)]:(u=t.split("")).every(function(n){return n===u[0]})?(i=w(r,t[0]),i=i[(t.length-1)%i.length],n.children[r.indexOf(i)]):null}(n,f);n&&n.focus()}function w(n,t){return n.filter(function(n){return 0===n.indexOf(t.toLowerCase())})}function b(t){var i=t.key,r=t.altKey,u=t.ctrlKey,t=t.metaKey;return!(1!==i.length||r||u||t)&&(e&&n.clearTimeout(e),e=n.setTimeout(function(){f=""},500),f+=i,1)}function r(n,t,i,r){var u=Element.prototype.matches||Element.prototype.msMatchesSelector;"string"==typeof i?n.addEventListener(t,function(n){u.call(n.target,i)&&r.call(n.target,n)}):(r=i,n.addEventListener(t,r))}function k(n,i){i=void 0!==i?i:[];"loading"!==t.readyState?n.apply(void 0,i):t.addEventListener("DOMContentLoaded",function(){n.apply(void 0,i)})}function o(){k(h)}var s=null,f="",e=null,d=0;r(t,"click",".fsb-button",function(n){var t=s===n.target;u();t||c(n.target);n.preventDefault();n.stopImmediatePropagation()});r(t,"keydown",".fsb-button",function(n){var t=n.target,r=t.nextElementSibling,i=!0;switch(n.key){case"ArrowUp":case"ArrowDown":case"Enter":case" ":c(t);break;default:b(n)?(c(t),p(r)):i=!1}i&&n.preventDefault()});r(t.documentElement,"mousemove",".fsb-option",function(n){n.target.focus()});r(t,"click",".fsb-option",function(n){l(n.target);u(!0)});r(t,"keydown",".fsb-option",function(n){var t=n.target,i=t.parentNode,r=!0;switch(n.key){case"ArrowUp":case"ArrowLeft":t.previousElementSibling&&t.previousElementSibling.focus();break;case"ArrowDown":case"ArrowRight":t.nextElementSibling&&t.nextElementSibling.focus();break;case"Home":i.firstElementChild.focus();break;case"End":i.lastElementChild.focus();break;case"PageUp":case"PageDown":break;case"Tab":l(t);u();r=!1;break;case"Enter":case" ":l(t);case"Escape":u(!0);break;default:b(n)?p(i):r=!1}r&&n.preventDefault()});r(t,"click",function(){u()});n.FancySelect=(o.init=h,o.replace=a,o.update=g,o);i&&k(h)}(window,document,"undefined"==typeof FancySelectAutoInitialize||FancySelectAutoInitialize);