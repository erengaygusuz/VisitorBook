...
namespace VisitorBook.UI.Validators
{
    public class RegisterApplicationViewModelValidator : AbstractValidator<RegisterApplicationViewModel>
    {
        ...
        public RegisterApplicationViewModelValidator(UserManager<User> userManager, IStringLocalizer<Language> localization)
        {
            _userManager = userManager;
            _localization = localization;

            RuleFor(x => x.RegisterApplication.Name)
            ...
            RuleFor(x => x.RegisterApplication.Surname)
            ...
            RuleFor(x => x.RegisterApplication.Email)
            ...
            RuleFor(x => x.RegisterApplication.Username)
