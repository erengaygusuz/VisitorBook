...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VisitorBook.Core.Entities.Visitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VisitorBook.Core.Entities.VisitorAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VisitorBook.Core.Entities.VisitedCounty", b =>
                {
                    ...
                    b.HasOne("VisitorBook.Core.Entities.Visitor", "Visitor")
                        .WithMany()
            ...
            modelBuilder.Entity("VisitorBook.Core.Entities.Visitor", b =>
                {
                    ...
                    b.HasOne("VisitorBook.Core.Entities.VisitorAddress", "VisitorAddress")
                        .WithMany()
